<?php
    ...
    $offset = ($page - 1) * $limit; 
    //Get totalpages
    $sql_query_totalPage = "SELECT COUNT(*) as total_pages FROM `tbl_event` WHERE `ev_id` = 2";
    ...
    $count = 0;
    $sql_query =  "SELECT * FROM `tbl_event` WHERE `ev_id` = 2 LIMIT $limit OFFSET $offset";//SQL command
    $count = 0;
