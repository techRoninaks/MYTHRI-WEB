<?php
    ...
    $sql_query = "select enquiry_id,enquiry_name,enquiry_phone,enquiry_email,enquiry_message,enquiry_type,enquiry_time,enquiry_status from tbl_enquiry rf where enquiry_status LIKE '%$srchKey%'";
